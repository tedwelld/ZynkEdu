            ...
            <p-dialog [(visible)]="adminDrawerVisible" [modal]="true" [draggable]="false" [dismissableMask]="true" [style]="{ width: 'min(34rem, 96vw)' }" [header]="adminDrawerMode === 'create' ? 'Add admin' : 'Edit admin'" appendTo="body">
                <div class="space-y-4">
                    <div *ngIf="adminDrawerMode === 'create'">
                        ...
                        <app-dropdown [options]="schoolSelectOptions" [(ngModel)]="adminDraft.schoolId" optionLabel="label" optionValue="value" class="w-full" appendTo="body" [filter]="true" filterBy="label" filterPlaceholder="Search schools" (opened)="loadData()"></app-dropdown>
                    </div>
                    <div>
